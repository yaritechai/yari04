...
function AppContent() {
  ...
  return (
    <div className={`h-screen flex ${isDarkMode ? 'bg-neutral-900' : 'bg-neutral-50'} overflow-hidden`}>
            ...
            <div className="w-full max-w-4xl flex flex-col items-center justify-center min-h-[60vh]">
              ...
              <div className="text-center mb-8">
                ...
                <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'} mb-8`}>
                  Start a conversation or create a new document!
                </p>

                {/* Action Buttons */}
                <div className="flex flex-col sm:flex-row gap-4 items-center justify-center mb-8">
                  <button
                    onClick={() => openFragment('document', { title: 'Untitled Document', content: '' })}
                  ...
                  <div className={`flex items-center gap-3 px-6 py-3 rounded-lg ${
                    isDarkMode ? 'text-gray-400 border border-neutral-700' : 'text-gray-600 border border-gray-200'
                  } border-dashed`}>
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                    </svg>
      ...
      {/* Floating Document Button - appears when in conversation */}
      {selectedConversationId && (
        <button
          onClick={() => openFragment('document', { title: 'Untitled Document', content: '' })}
          className={`fixed bottom-24 right-6 w-14 h-14 rounded-full shadow-lg transition-all hover:scale-105 z-50 ${
            isDarkMode 
              ? 'bg-neutral-800 text-gray-200 hover:bg-neutral-700 border border-neutral-700' 
